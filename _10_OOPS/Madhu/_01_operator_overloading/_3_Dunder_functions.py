...
madhu = Employee(100)
print("Madhu object 2:", madhu)  # madhu.__str__()
...
class Employee(object):
    ...
    def __ge__(self, var):
        return self.eid >= var.eid

madhu = Employee(100)
print("Madhu object 2:", madhu)  # madhu.__str__()

yu = Employee(200)
print("Compare objects : ", madhu >= yu)  # madhu.__ge__(yu)
print("Compare objects : ", madhu > yu)  # madhu.__gt__(yu)
