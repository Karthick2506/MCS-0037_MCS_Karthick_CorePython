...
Here, we are taking a slightly more complicated file to read, called phone_data.csv, which 
contains data of company employees.
'''


"""import pandas
df = pandas.read_csv('phone_data.csv')
print("Data of company employees: \n", df)"""
