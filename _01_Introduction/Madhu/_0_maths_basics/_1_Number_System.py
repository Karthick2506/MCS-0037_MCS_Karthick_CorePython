...
'''
'''
Number System <==> Data types/ Data structures


Integer Whole Fractional Real  Imaginary   ==> Data Types     ===> int float boolean
Sets, Sequences, Matrices                  ==> Data Structures ==> String List Tuple Dictionary Set
'''
'''
Number System
=====================
...
Imaginary nos*  : 3i+4j                              ==> imaginary
                        # 3 realno # 4 imaginaryno

CONCEPT:
----------------                 MATHS                 PYTHON
int whole fraction          ===>  Number System   ===> Data Types (int float complex bool)
